...
-- 페르소나 공유 아키텍처 반영 (persona-sharing-architecture.md)
-- ============================================================================
...
COMMENT ON TABLE persona_profiles IS 'AI 페르소나 정의 - 공유 기능 포함 (private/public/unlisted)';
...
COMMENT ON FUNCTION update_persona_usage IS '세션 생성 시 페르소나 사용 횟수 자동 증가 (생성자/공개 사용 구분)';
...
-- ============================================================================
-- 5. FOREIGN KEY 제약조건 (profiles.my_avatar_persona_id)
-- ============================================================================

-- persona_profiles 테이블이 생성된 후 FK 추가
...
SELECT
  ...
  p.enneagram,
  p.usage_count,
  p.creator_usage_count,
  p.public_usage_count,
  p.last_used_at,
...
COMMENT ON VIEW active_persona_stats IS '활성 페르소나 사용 통계 (생성자 정보 포함)';
